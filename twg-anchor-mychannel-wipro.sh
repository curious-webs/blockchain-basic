...
jq '.channel_group.groups.Application.groups.WIPRO.values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "peer0.wipro.com","port": 9051}]},"version": "0"}}' channel-artifacts-anchor/${CHANNEL_NAME}_config.json > channel-artifacts-anchor/modified_anchor_${CHANNEL_NAME}.json
